/* =========================================================
   ProductCatalogue.merged.js
   - Merges teammate's catalogue + your guarded data/overrides
   - Single source of truth via window.ProductData
   ========================================================= */

/* ---------- Guarded shared product data (defines once) ---------- */
if (!window.ProductData) {
  (function () {
    // Base products: merged to prefer the best/most recent images.
    // Footwear (IDs 1,8,11,12,13) prefer HER images; Gear/Safety prefer YOUR updated assets.
    const PRODUCTS = [
...
<<<<<<< HEAD
      ...
      { id: 5,  name: "GPS Navigation Device", brand: "TrailTech", category: "safety",
        ...
        image: "../images/gps.jpg", // your improved asset
      ...
      { id: 7,  name: "Trekking Poles Set", brand: "StableStep", category: "gear",
        ...
        image: "../images/trekkingpoles.jpg", // your improved asset
      ...
      { id: 8,  name: "Trail Running Shoes", brand: "SpeedTrail", category: "footwear",
        ...
        image: "../images/Trail Running Shoes.jpg", // HER updated footwear image
      ...
      { id: 9,  name: "Hydration Backpack", brand: "HydroFlow", category: "gear",
        ...
        image: "../images/hydrationbackpack.jpg", // your improved asset
      ...
      { id: 12, name: "Lightweight Hiking Sandals", brand: "ComfortWalk", category: "footwear",
        ...
        image: "../images/Lightweight Hiking Sandals.jpeg", // HER
        features: ["Quick Dry","Water Friendly","Lightweight","Adjustable Straps"], inStock: true, dateAdded: "2024-02-15" },
      ...
      { id: 13, name: "Winter Hiking Boots", brand: "WinterTrek", category: "footwear",
        ...
        image: "../images/Winter Hiking Boots.jpeg", // HER
...
>>>>>>> origin/dev
      ...
      { id: 16, name: "Portable Camping Stove", brand: "FlameMax", category: "gear",
        ...
        image: "../images/stove.jpg", // your improved asset
      ...
      { id: 21, name: "Emergency Whistle", brand: "SafeSound", category: "safety",
        ...
        image: "../images/whistle.png", // your improved asset
      ...
      { id: 22, name: "First Aid Kit", brand: "MedTrail", category: "safety",
        ...
        image: "../images/firstaidkit.png", // your improved asset
      ...
      { id: 23, name: "Emergency Beacon", brand: "RescueLink", category: "safety",
        ...
        image: "../images/beacon.jpg", // your improved asset
      ...
      { id: 24, name: "Reflective Safety Vest", brand: "VisibleTrek", category: "safety",
        ...
        image: "../images/vest.png", // your improved asset
...
function clearAllFilters() {
  ...
  ids.forEach(id => {
    ...
    if (!el) return;
    if (id === 'sortBy') el.value = 'name';
    else if (id === 'productSearch') el.value = '';
    else el.value = 'all';
  });
...
// Accessibility: focus search on Ctrl+F
